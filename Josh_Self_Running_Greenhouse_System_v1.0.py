...
""")
    ...
    submittal_pdf = create_pdf_submittal(num_bays=num_bays, length_ft=order['config']['total_length_ft'], load_package=load_package)
    submittal_svg = create_svg_general_arrangement(num_bays=num_bays)
